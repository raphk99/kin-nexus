    ...
    <main className="flex min-h-screen flex-col p-8 bg-obsidian text-white font-sans max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 flex flex-col hover:border-white/20 transition-all">
            <h3 className="text-xl font-bold text-neutral-300 mb-2">PS4 Day Pass</h3>
            <div className="text-3xl font-bold text-white mb-6">$3 <span className="text-sm text-neutral-500 font-normal">/ day</span></div>
            <ul className="space-y-4 mb-8 flex-1">
                 <li className="flex items-center gap-3 text-sm text-neutral-300">
                    <Check className="w-4 h-4 text-lime-cyber" /> Access to PS4
                 </li>
                 <li className="flex items-center gap-3 text-sm text-neutral-300">
                    <Check className="w-4 h-4 text-lime-cyber" /> 5 Hours of Playtime
                 </li>
            </ul>
        ...
        <div className="rounded-2xl border-2 border-cobalt-electric bg-obsidian p-8 flex flex-col relative scale-105 shadow-[0_0_30px_rgba(0,71,171,0.3)]">
            ...
            <h3 className="text-xl font-bold text-white mb-2">PS5 Day Pass</h3>
            <div className="text-3xl font-bold text-cobalt-electric mb-6">$10 <span className="text-sm text-neutral-500 font-normal">/ day</span></div>
            <ul className="space-y-4 mb-8 flex-1">
                 <li className="flex items-center gap-3 text-sm text-white">
                    <Check className="w-4 h-4 text-cobalt-electric" /> Unlimited Playtime
                 </li>
                 <li className="flex items-center gap-3 text-sm text-white">
                    <Check className="w-4 h-4 text-cobalt-electric" /> Access to PS5
                 </li>
                 <li className="flex items-center gap-3 text-sm text-white">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 flex flex-col hover:border-lime-cyber/30 transition-all">
            <h3 className="text-xl font-bold text-lime-cyber mb-2">Pro Membership</h3>
            <div className="text-3xl font-bold text-white mb-6">$50 <span className="text-sm text-neutral-500 font-normal">/ mo</span></div>
            <ul className="space-y-4 mb-8 flex-1">
                 <li className="flex items-center gap-3 text-sm text-neutral-300">
                    <Check className="w-4 h-4 text-lime-cyber" /> Unlimited Access
                 </li>
                 <li className="flex items-center gap-3 text-sm text-neutral-300">
                    <Check className="w-4 h-4 text-lime-cyber" /> RTX 4090 Station Priority
                 </li>
                 <li className="flex items-center gap-3 text-sm text-neutral-300">
